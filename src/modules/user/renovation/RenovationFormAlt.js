...
const RenovationFormAlt = ({navigation, route}) => {
    ...
    const onSubmitPress = () => {
        ...
        if (details == '' && audioUri == '') {
            ...
            postRequest(data, renovationUrl, token).then(res => {
                setLoading(false)
                res === 1
                    ? navigation.reset({
                          index: 0,
            ...
            <ImageBackground style={{flex: 1}} source={Images.BACKGROUND}>
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{padding: 16}}>
                        ...
                        {(params.service == 'Floor' ||
                            params.service == 'Cieling') && (
                            <View style={{marginTop: 10}}>
                                <Text style={styles.bold}>
                                    {params.service} Area (sq feet)
                                </Text>
                                <View style={[styles.shadow, styles.inputCont]}>
                                    <TextInput
                                        value={area}
...
export default RenovationFormAlt
